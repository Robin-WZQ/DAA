...
def main():
    ...
    value = metrics['attention_node_trace'][0] + metrics['attention_node_trace'][1] + metrics['attention_node_trace'][2] + metrics['attention_node_trace'][3] + metrics['attention_node_trace'][4] + metrics['attention_node_trace'][5] + metrics['attention_node_trace'][6]
