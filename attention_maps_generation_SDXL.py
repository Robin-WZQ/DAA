...
def create_parser():
    ...
    parser.add_argument('-d',
                        '--data',
                        default='/mnt/sdb1/wangzhongqi/project/backdoor_detection/DAA-main-rebuttal/data/Prompts/test/Rickrolling/test_data_1.txt',
                        type=str,
    ...
    parser.add_argument('-b',
                        '--backdoor_model_path',
                        default='/mnt/sdb1/wangzhongqi/project/backdoor_detection/DAA-main-rebuttal/Rebuttal/Models/SDXL/backdoor_1',
                        type=str,
                        required=False,
    ...
    parser.add_argument('-np',
                        '--npy_save_path',
                        default='./data/Attention_maps/test',
                        type=str,
                        required=False,
                        dest="npy_save_path",
                        help='npy save path')
    ...
    parser.add_argument('--model',
                        required=False,
                        dest="model",
                        default="/mnt/sdb1/wangzhongqi/Models/stable-diffusion-xl-base-1.0",
                        )
...
def main():
    ...
    ldm_stable = StableDiffusionXLPipeline.from_pretrained(args.model,safety_checker = None)
    ...
    # load backdoor model
    if args.backdoor_model_name == 'Rickrolling':
        encoder = CLIPTextModel.from_pretrained(args.backdoor_model_path + '/' + 'CLIPTextModel')
        ldm_stable.text_encoder = encoder.to(device)
        encoder_2 = CLIPTextModelWithProjection.from_pretrained(args.backdoor_model_path + '/' + 'CLIPTextModelWithProjection')
        ldm_stable.text_encoder_2 = encoder_2.to(device)
    else:
